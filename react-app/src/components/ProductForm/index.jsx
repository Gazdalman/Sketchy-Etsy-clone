...
const ProductFormPage = ({ type, product }) => {
  ...
  return !imageLoading ? (
    <div className="mew-product-page">
      ...
      <div className="new-product-form-container">
        ...
        >
          ...
          <div className="new-product-btns">
            <button type="submit" disabled={disabled}  className="submit-create">
              {type == "edit" ? "Edit Product" : "Create Product"}
            </button>
            <button onClick={(e) => goBack(e)} className="cancel-create">Cancel</button>
          </div>
        </form>
